...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'App.credits'
        db.add_column(u'api_app', 'credits',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'App.credits'
        db.delete_column(u'api_app', 'credits')
    ...
    models = {
        u'api.app': {
            ...
            'credits': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '5'}),
            'formation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.Formation']"}),
            'heartbeats': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
